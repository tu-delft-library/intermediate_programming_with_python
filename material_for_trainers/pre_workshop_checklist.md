...
## `edu.nl` link
- Make an [edu.nl](https://edu.nl/) link to point to `materials_for_participants` folder in on the `branch` specific for the course
- This folder should contain:
    - a `README` file with links and exercises participants will need 
        - equivalent of a collaborative document
    - a `command.log` file for autopush
    - any other material needed during the lesson (e.g. cheat sheet)

## Feedback form
-  Ask Paula to set up the feedback survey
    - Add link to the `README` document

## Slides

- Update the [slides](https://tud365.sharepoint.com/:p:/r/sites/ResearchDataServices/Gedeelde%20documenten/Training/Research_Software_Training/lesson_plans/resources/Intermediate%20programming%20with%20Python.pptx?d=w0c2ead6d71874acca3944dcdff26f1f9&csf=1&web=1&e=DiaCJU)
    - Names of trainers/helpers
    - Modify schedule (if needed)
    - Add QR + with `edu.nl` link
...
- Practice teaching the material on your own (see `lesson_plan.md` in this repo and/or the [lesson plan spreadsheet](https://tud365.sharepoint.com/:x:/r/sites/ResearchDataServices/Gedeelde%20documenten/Training/Research_Software_Training/lesson_plans/lesson_plan.xlsx?d=we808cfe275964b25a61e1fa97fc31664&csf=1&web=1&e=aiOuB7) for content)
...
- Write the edu.nl link pointing to `README` document on the whiteboard 
